...
class ErrorEvent(val Context: String, val ShortExceptionInfo: String, val ServiceNameInError: String, val ServiceIdInError: String, val ExceptionInfo: String, agentIdentification: AgentIdentification)
    extends OriginatingEvent(agentIdentification) {
